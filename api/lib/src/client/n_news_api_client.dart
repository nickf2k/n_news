...
import 'package:n_news_api/client.dart';
import 'package:http/http.dart' as http;

/// {@template n_news_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class NNewsApiMalformedResponse implements Exception {
  /// {@macro n_news_api_malformed_response}
  const NNewsApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template n_news_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class NNewsApiRequestFailure implements Exception {
  /// {@macro n_news_api_request_failure}
  const NNewsApiRequestFailure({
...
/// {@template n_news_api_client}
/// A Dart API client for the N-News API.
/// {@endtemplate}
class NNewsApiClient {
  /// Create an instance of [NNewsApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro n_news_api_client}
  NNewsApiClient({
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        NNewsApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
