...
void main() {
  ...
  group('NNewsApiClient', () {
    late http.Client httpClient;
    late NNewsApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = NNewsApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => NNewsApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = NNewsApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws NNewsApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<NNewsApiMalformedResponse>()),
        );
      });

      test(
          'throws NNewsApiRequestFailure '
